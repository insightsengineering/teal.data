...
adsl <- cdisc_dataset_connector(
  dataname = "ADSL",
  pull_callable = callable_function(function() example_cdisc_data("ADSL")),
  label = "ADSL connector"
)

adae <- cdisc_dataset_connector(
  dataname = "ADAE",
  pull_callable = callable_function(function() example_cdisc_data("ADAE")),
  label = "ADAE connector"
)

advs <- cdisc_dataset_connector(
  dataname = "ADVS",
  pull_callable = callable_function(function() example_cdisc_data("ADVS")),
  label = "ADVS connector"
)

adtte <- dataset_connector(
  dataname = "ADTTE",
  pull_callable = callable_function(function() example_cdisc_data("ADTTE")),
