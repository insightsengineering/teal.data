...
adsl <- cdisc_dataset_connector(
  dataname = "ADSL",
  pull_callable = callable_function(function() slice_example_cdisc_data("ADSL")),
  keys = get_cdisc_keys("ADSL"),
  label = "ADSL connector"
)
...
adrs <- cdisc_dataset_connector(
  dataname = "ADRS",
  pull_callable = callable_function(function() slice_example_cdisc_data("ADRS")),
