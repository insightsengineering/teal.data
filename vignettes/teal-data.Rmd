...
- [Specifying `ADaM` data](including-adam-data-in-teal.html)
- [Specifying `MultiAssayExperiment` data](including-mae-data-in-teal.html)
- [Specifying general relational data](including-general-data-in-teal.html)
