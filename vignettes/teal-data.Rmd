...
Primary function of `teal_data` is to provide reproducibility of data. We recommend to initialize empty `teal_data` which marks object as _verified_. Read more in [teal_data Reproducibility](teal-data-reproducibility.html).
