...
- `code` - a string containg code to reproduce the `data` (details in [teal_data reproducibility ](teal-data-reproducibility.html)).
...
Primary function of `teal_data` is to provide reproducibility of data. Recommended prative is to iniitalize empty `teal_data` which marks object as _verified_. Read more in [teal_data Reproducibility](teal-data-reproducibility.html).
