...
A `teal_data` is meant to be used for reproducibility purposes. The class inherits from [`qenv`](https://pharmaverse.github.io/teal.code/latest-tag/articles/qenv.html) and we encourage to get familiar with [`teal.code`](https://pharmaverse.github.io/teal.code/latest-tag/) first. `teal_data` has following characteristics:
