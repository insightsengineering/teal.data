...
## Overview
`teal.data` gives `teal` applications the possibility to define individual keys per dataset and to define the relations 
to other datasets.

Each table passed into a `teal` app can have a set of keys that inform `teal` about its structure and relation
