...
Additionally, it plays a role in the data filtering using the _[Filter Panel](https://pharmaverse/teal/latest-tag/articles/filter-panel.html)_ in a `teal` application.
