...
data <- teal.data:::TealData$new(iris_ds, check = TRUE)
...
```{r, error=TRUE}
# throws an error:
data <- teal.data:::TealData$new(dataset("iris", iris, code = "iris <- mtcars"), check = TRUE)

data <- teal.data:::TealData$new(dataset("iris", iris, code = "iris <- mtcars"), check = FALSE)
