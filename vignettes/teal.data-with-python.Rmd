...
In this section we show a simple example showing how python code can be used to create a `teal` dataset.
...
# reticulate function to call to install the pandas package if not installed
# py_install("pandas") 
library(teal.data)
```
