...
#' Note that the datasets are not created and maintained in `teal.data`, they are retrieved from [`random.cdisc.data`][random.cdisc.data::random.cdisc.data-package] package.
#'
