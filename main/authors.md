...
Source:
[`DESCRIPTION`](https://github.com/insightsengineering/teal.data/blob/main/DESCRIPTION)

Kaledkowski D, Chlebowski A, Kosinski M, Verissimo A, Rucki P, Hallal M,
Burkoff N, Nasinski M, Pagacz K, Zhao J (2025). *teal.data: Data Model
for 'teal' Applications*. R package version 0.8.0.9001,
